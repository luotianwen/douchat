...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='微信插件表' AUTO_INCREMENT=229 ;
...
(223, 'Payment', '支付设置', '微信支付,财富通,支付宝', 1, '{"isopen":"1","isopenload":"1","isopenwx":"1"}', '艾逗笔', '1.0', 1455705718, 1, 0, 1, 1),
(224, 'UserCenter', '用户中心', '实现3G首页、微信登录，微信用户绑定，微信用户信息初始化等基本功能', 1, '{"score":"100","experience":"100","need_bind":"0","bind_start":"0","jumpurl":""}', '艾逗笔', '1.0', 1455705730, 1, 0, 1, 1),
(227, 'WeiSite', '微网站', '微3G网站、支持分类管理，文章管理、底部导航管理、微信引导信息配置，微网站统计代码部署。同时支持首页多模板切换、信息列表多模板切换、信息详情模板切换、底部导航多模板切换。并配置有详细的模板二次开发教程', 1, '{"title":"\\u70b9\\u51fb\\u8fdb\\u5165\\u9996\\u9875","cover":"","info":"","background":"","code":"","template_index":"ColorV1","template_footer":"V1","template_lists":"V1","template_detail":"V1"}', '艾逗笔', '1.0', 1455705765, 0, 0, 1, 1),
(220, 'AutoReply', '自动回复', '实现配置关键词，用户回复此关键词后自动回复对应的文件，图文，图片信息', 1, 'null', '艾逗笔', '1.0', 1455705608, 1, 0, 1, 1),
(221, 'CustomMenu', '自定义菜单', '自定义菜单能够帮助公众号丰富界面，让用户更好更快地理解公众号的功能', 1, 'null', '艾逗笔', '1.0', 1455705621, 1, 0, 1, 1);
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='模型属性表' AUTO_INCREMENT=12608 ;
...
(1, 'WEB_SITE_TITLE', 1, '网站标题', 1, '', '网站标题前台显示标题', 1378898976, 1430825115, 1, '', 0),
...
(47, 'FOLLOW_YOUKE_UID', 0, '粉丝游客ID', 0, '', '', 1398927704, 1398927704, 1, '-11937', 0),
...
(50, 'COPYRIGHT', 1, '版权信息', 1, '', '', 1401018910, 1401018910, 1, '', 3),
...
(17, 'weixin', '微信插件必须加载的钩子', 1, 1388810858, 'Hitegg,Diy,RedBag,WeMedia,ShopCoupon,Card,SingIn,Seckill,AutoReply,CustomMenu,Payment,UserCenter,WeiSite'),
...
(2, 0, '', '应用商城', 1, '', 'http://douchat.cc/?/shop/', '_blank', 0, 2, 1),
(3, 0, '', '交流社区', 1, '', 'http://douchat.cc/?/question/', '_blank', 0, 3, 1),
...
(44, '系统插件', 43, 1, 'Admin/Plugin/index', 0, '', '扩展', 0),
...
(57, '云平台插件', 43, 3, 'Admin/Addons/yun', 0, '', '扩展', 0),
...
(76, '导航管理', 68, 6, 'Channel/index', 0, '', '系统设置', 1),
...
(124, '本地插件', 43, 0, 'Admin/Addons/index', 0, '', '扩展', 0),
(126, '公众号等级', 16, 0, 'admin/PublicGroup/PublicGroup', 0, '', '公众号管理', 0),
(127, '公众号管理', 16, 1, 'admin/PublicGroup/PublicAdmin', 0, '', '公众号管理', 0),
(128, '在线升级', 68, 5, 'Admin/Update/index', 0, '', '系统设置', 1),
(129, '清除缓存', 68, 10, 'Admin/Update/delcache', 0, '', '系统设置', 0),
(130, '云服务', 0, 8, 'Admin/yunservice/index', 0, '', '', 0),
(131, '交流问答', 130, 2, 'Admin/yunservice/communication', 0, '', '系统服务', 0),
(132, '在线更新', 130, 1, 'Admin/yunservice/upgrade', 0, '', '系统服务', 0),
(133, '已购买应用', 130, 1, 'Admin/yunservice/buyed', 0, '', '应用中心', 0),
(134, '站点信息', 130, 0, 'Admin/yunservice/siteinfo', 0, '', '站长中心', 0),
(135, 'Bug反馈', 130, 3, 'Admin/yunservice/feedback', 0, '', '系统服务', 0),
(136, '查看更多应用', 130, 2, 'Admin/yunservice/moreapps', 0, '', '应用中心', 0),
(137, '二次开发教程', 130, 3, '/wiki', 0, '', '应用中心', 1),
(138, '应用购买记录', 130, 0, 'Admin/yunservice/record', 0, '', '站长中心', 0),
(139, '我的账户', 130, 0, 'Admin/yunservice/account', 0, '', '站长中心', 0),
(140, '交流问答', 130, 0, 'Admin/yunservice/communication', 0, '', '站长中心', 1),
(141, '官方交流论坛', 130, 4, '/bbs', 0, '', '应用中心', 1),
(142, '在线充值', 130, 0, 'admin/yunservice/index?type=online_recharge', 0, '', '站长中心', 1),
(143, '系统公告', 130, 0, 'Admin/yunservice/notice', 0, '', '系统服务', 0),
(144, '公告管理', 68, 4, 'Notice/lists', 0, '', '系统设置', 1),
(147, '图文样式编辑', 68, 4, 'ArticleStyle/lists', 0, '', '系统设置', 0),
(148, '增加', 147, 0, 'ArticleStyle/add', 0, '', '', 0),
(149, '分组管理', 147, 0, 'ArticleStyle/group', 0, '', '', 0),
(150, '微信接口节点', 16, 0, 'Admin/Rule/wechat', 0, '', '用户管理', 1),
(151, '公众号组管理', 16, 0, 'Admin/AuthManager/wechat', 0, '', '用户管理', 1),
...
CREATE TABLE IF NOT EXISTS `dc_model` (
  ...
  PRIMARY KEY (`id`),
  KEY `name` (`name`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='系统模型表' AUTO_INCREMENT=1287 ;
