          ...
          $.each(data,function(i,item){
            if ( area == 'communication' ){
              var item = '<li class="mp_news_item">'+
                      '<a href="'+remote_url+'?/question/'+item.question_id+'" target="_blank" title="'+data[i].title+'">'+
                ...
                var item = '<li class="mp_news_item">'+
                    '<a href="'+remote_url+'?/article/'+item.id+'" target="_blank" title="'+data[i].title+'">'+
                ...
                var item = '<li class="mp_news_item">'+
                    '<a href="'+remote_url+'?/notice/'+item.id+'" target="_blank" title="'+data[i].title+'">'+
                        '<strong style="width:300px;">'+data[i].title
                    if (i<3){
                      item += '<i class="icon_common new"></i>';
                    }
                ...
                var item = '<li class="mp_news_item">'+
                    '<a href="'+remote_url+'?/feedback/'+item.id+'" target="_blank" title="'+data[i].title+'">'+
